...
path_dictionary = "../en-de-dictionary.txt"
#Hint: Make sure that the dictionary contains language 1 before language 2


path_embeddings = "../word2vec/eng-ger/sgns"

path_frequency_sheet_1 = "../english_frequency_leeds.txt"
path_frequency_sheet_2 = "../german_frequency_leeds.txt"

path_output_excel = "./Cosine_Sims_Eng_Ger.xlsx"
path_output_csv = "./cosine_sims_eng_ger.csv"

name_excel_sheet = 'English-German'
...
def read_freq_tables():
    ...
    file = open(path_frequency_sheet_1, "r")
    dict_en = {}
    ...
    for line in file:
        if line != "\n":
            ...
            word = word[:-1]
            dict_en[word] = (rank, rel_freq)
        
    file.close()
    
    file = open(path_frequency_sheet_2, "r")
    dict_ger = {}
    ...
    for line in file:
        if line != "\n":
            ...
            word = word[:-1]
            word = word.lower()
            dict_ger[word] = (rank, rel_freq)
        
    file.close()
    
    return dict_en, dict_ger
...
def read_dict():
    file = open(path_dictionary, "r") #change dictionary here
    dict_1_2 = {}
    dict_2_1 = {}
